      ...
      >
        ...
        <Card className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 shadow-2xl">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-bold text-slate-800 dark:text-slate-200">Welcome back</CardTitle>
          ...
          <CardContent className="space-y-6">
            ...
            >
              <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Demo Accounts</h4>
              <div className="space-y-2 text-sm">
                <div>
                  <strong>Admin:</strong> admin@wordvale.com / admin123
                </div>
                <div>
                  <strong>User:</strong> user@wordvale.com / user123
                </div>
                <div>
                  <strong>Author:</strong> author@wordvale.com / author123
                </div>
              </div>
            </motion.div>
